...
//  			System.out.print("주문번호의 주문상품 개수 : " +size);
      ...
      System.out.println("1.주문상세조회 2. 구매확정 \t0.돌아가기");
      ...
      case 2 : {
    	  ...
    	  snumber = ScanUtil.nextInt();
    	  System.out.println(selectorderDao.selectorder().get(snumber).get("ORDER1_NO").toString());
   adminOrderDao.modifydeliverstatus("구매확정", selectorderDao.selectorder().get(snumber).get("ORDER1_NO").toString()); // 주문상태 변경
   System.out.println("선택하신 주문의 상태가 구매확정으로 변경되었습니다.");
    	  }
