...
<c:set var="iCourseList" value="${dataMap.iCourseList }" />
...
<!-- BEGIN: Content-->
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="d-flex justify-content-end">
            	<button class="btn btn-danger btn-lg" onclick="qr_go()" >
                   <span class="align-middle">출석하기</span></button>
			</div>
			<div class="modal modal-slide-in fade" id="qr-sidebar">
                    ...
                    <div class="app-calendar overflow-hidden border">
                        <div class="row g-0">
                            ...
                            <div class="col app-calendar-sidebar flex-grow-0 overflow-hidden d-flex flex-column" id="app-calendar-sidebar">
                                ...
                                <div class="mt-auto">
                                    <img src="/lms/resources/vuexy/app-assets/images/pages/calendar-illustration.png" alt="Calendar illustration" class="img-fluid" />
                                </div>
                            </div>
                            <!-- /Sidebar -->
    ...
    <script>
    var events = [
		<c:forEach items="${iCourseList }" var="iCourse">
	{
		id : '${iCourse.ingCourseCode}',
		title : '${iCourse.asCourseName}', 
		start : '<fmt:formatDate value="${iCourse.ingCourseBeginDate }" pattern="yyyy-MM-dd"/>',
		end : '<fmt:formatDate value="${iCourse.ingCourseEndDate }" pattern="yyyy-MM-dd"/>',
		extendedProps : {
			'calendar' : 'Business'
		}
	},
...
/*     function regist() {
    	...
    	//form은 name속성을 가져온다. id가 아니라. 전달해줄때도 속성이름이 name이다.
    ...
    var window;
    function qr_go() {
    	var options ='top=100, left=100, width=500, height=600, status=no, menubar=no, toolbar=no, resizable=no';
		var url = 
    	window = window.open(url, "qrcheck", options)
	}

    
    </script>
    
    <script src="/lms/resources/vuexy/app-assets/js/scripts/pages/app-calendar.js"></script>
    <!-- END: Page JS-->