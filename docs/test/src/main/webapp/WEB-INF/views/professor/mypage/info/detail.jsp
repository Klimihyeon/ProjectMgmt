...
<div class="tab-content">
        ...
        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
          ...
          <div class="d-flex mb-2">
            <img src="../../../app-assets/images/avatars/7.png" alt="users avatar" class="user-avatar users-avatar-shadow rounded me-2 my-25 cursor-pointer" height="90" width="90">
            <div class="mt-50">
              <h4>${prof.profId }</h4>
          ...
          <form class="form" method="post" action="modify.do" name="modifyForm">
            <div class="row">
            <div class="col-md-4">
                <div class="mb-1">
              ...
              <div class="col-md-4">
                <div class="mb-1">
                  <label class="form-label" for="userRePwd">비밀번호확인</label>
                  <input type="password" class="form-control" placeholder="비밀번호를 재확인합니다." value="" name="userRePwd" id="userRePwd" onkeyup="checkPwd()">
                </div>
              </div>
              <div class="col-md-4">
              </br>
              ...
              <div class="col-md-4">
                <div class="mb-1">
                  ...
                  <input type="email" class="form-control" placeholder="이메일을 입력해주세요" value="${prof.profEmail }" name="profEmail" id="profEmail">
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-1">
