                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">${cb.cbTitle }</h4>
                                        <div class="d-flex">
                                            ...
                                            <div class="author-info">
                                                ...
                                                <small><a href="#" class="text-body">${cb.cbWriter }</a></small>
                                                <span class="text-muted ms-50 me-25">|</span>
                                                <small class="text-muted"><fmt:formatDate value="${cb.cbDate }" pattern="yyyy-MM-dd" /></small>
                                            </div>
                                        </div>
                                        <br>
...
<%-- 															 onclick="location.href='<%=request.getContextPath()%>/student/manage/board/qna/getFile.do?cqbAno=${attach.cqbAno }';"> --%>
<!-- 															<div class="info-box">	 -->
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="#">
                                                        <div class="text-body align-middle">${cb.cbCnt }</div>
                                                    </a>
                                                </div>
                                            </div>
