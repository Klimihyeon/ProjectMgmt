            ...
            <div class="container">
                <div class="row mt-5 align-items-center">
                    ...
                    <div class="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <img src="<%=request.getContextPath() %>/resources/vuexy/images/illustrator/Startup_SVG.svg" alt="">
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                        <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/amazon.svg" class="avatar avatar-ex-sm" alt="">
                    </div><!--end col-->

                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                        <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/google.svg" class="avatar avatar-ex-sm" alt="">
                    </div><!--end col-->

                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                        <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/lenovo.svg" class="avatar avatar-ex-sm" alt="">
                    </div><!--end col-->

                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                        <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/paypal.svg" class="avatar avatar-ex-sm" alt="">
                    </div><!--end col-->

                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                        <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/shopify.svg" class="avatar avatar-ex-sm" alt="">
                    </div><!--end col-->

                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                        <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/spotify.svg" class="avatar avatar-ex-sm" alt="">
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6 mt-4 pt-2">
                        <img src="<%=request.getContextPath() %>/resources/vuexy/images/illustrator/SEO_SVG.svg" alt="">
                    </div><!--end col-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <div class="card rounded border-0 shadow ms-lg-5">
                            <div class="card-body">
                                <img src="<%=request.getContextPath() %>/resources/vuexy/images/illustrator/Mobile_notification_SVG.svg" alt="">
                        ...
                        <div class="tiny-three-item">
                            <div class="tiny-slide text-center">
                                <div class="client-testi rounded shadow m-2 p-4">
                                    <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/amazon.svg" class="img-fluid avatar avatar-ex-sm mx-auto" alt="">
                            ...
                            <div class="tiny-slide text-center">
                                <div class="client-testi rounded shadow m-2 p-4">
                                    <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/google.svg" class="img-fluid avatar avatar-ex-sm mx-auto" alt="">
                            ...
                            <div class="tiny-slide text-center">
                                <div class="client-testi rounded shadow m-2 p-4">
                                    <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/lenovo.svg" class="img-fluid avatar avatar-ex-sm mx-auto" alt="">
                            ...
                            <div class="tiny-slide text-center">
                                <div class="client-testi rounded shadow m-2 p-4">
                                    <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/paypal.svg" class="img-fluid avatar avatar-ex-sm mx-auto" alt="">
                            ...
                            <div class="tiny-slide text-center">
                                <div class="client-testi rounded shadow m-2 p-4">
                                    <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/shopify.svg" class="img-fluid avatar avatar-ex-sm mx-auto" alt="">
                            ...
                            <div class="tiny-slide text-center">
                                <div class="client-testi rounded shadow m-2 p-4">
                                    <img src="<%=request.getContextPath() %>/resources/vuexy/images/client/spotify.svg" class="img-fluid avatar avatar-ex-sm mx-auto" alt="">
