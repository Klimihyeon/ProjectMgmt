...
<title>JobStick Manage Page</title>
<head>
</head>
...
<div class="app-content content">
		...
		<div class="content-wrapper container-xxl p-0">
			...
			<div class="content-body">
				<iframe id="ifr" name="ifr" src="<%=request.getContextPath()%>/student/manage/main.do" frameborder="0" style="width: 99%;" onLoad="resizeHeight('ifr');"></iframe>
			</div>
		</div>
	</div>
