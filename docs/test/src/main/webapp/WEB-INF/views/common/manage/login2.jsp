...
<head>
    ...
    <title>JobStick 관리자 로그인 페이지</title>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/vuexy/app-assets/css/pages/page-auth.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                	 <img viewbox="0 0 139 95" alt="" src="<%=request.getContextPath() %>/resources/vuexy/images/logo.jsp">
...
<!--                                         </g> -->
<!--                                     </svg> -->
                                    <h2 class="brand-text text-primary ml-1">JobStick</h2>
                                </a>

                                <h4 class="card-title mb-1">JobStick에 오신 것은 환영합니다.</h4>
<!--                                 <p class="card-text mb-2">Please sign-in to your account and start the adventure</p> -->
                                <form class="auth-login-form mt-2" action="<%=request.getContextPath() %>/manage/login.do" method="POST">
                                    <div class="form-group">
                                        <label for="login-id" class="form-label">ID</label>
                                        <input type="text" class="form-control" id="login-email" name="id" placeholder="ID를 적어주세요" aria-describedby="login" tabindex="1" autofocus />
                                    </div>
                                ...
                                <p class="text-center mt-2">
                                    <a href="/lms/home/main.do">
                                  	  <span>JobStick 페이지로 가기 ?</span>
                                    </a>
                                </p>
