...
<%@ page trimDirectiveWhitespaces="true"%>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/vuexy/app-assets/vendors/css/forms/spinner/jquery.bootstrap-touchspin.css">
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/vuexy/app-assets/css/pages/app-ecommerce-details.css">
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/vuexy/app-assets/css/plugins/forms/form-number-input.css">
