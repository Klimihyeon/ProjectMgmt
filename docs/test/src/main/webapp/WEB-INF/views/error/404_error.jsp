...
<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- favicon -->
        <link rel="shortcut icon" href="<%=request.getContextPath() %>/resources/landrick/images/favicon.ico">
        <!-- Bootstrap -->
        <link href="<%=request.getContextPath() %>/resources/landrick/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- Icons -->
        <link href="<%=request.getContextPath() %>/resources/landrick/css/materialdesignicons.min.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="https://unicons.iconscout.com/release/v3.0.6/css/line.css">
        <!-- Main Css -->
        <link href="<%=request.getContextPath() %>/resources/landrick/css/style.css" rel="stylesheet" type="text/css" id="theme-opt" />
        <link href="<%=request.getContextPath() %>/resources/landrick/css/colors/default.css" rel="stylesheet" id="color-opt">
    </head>
    ...
    <body>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-12 text-center">
                        <img src="<%=request.getContextPath() %>/resources/landrick/images/404.svg" class="img-fluid" alt="">
        ...
        <!-- Main Js -->
        <script src="<%=request.getContextPath() %>/resources/landrick/js/plugins.init.js"></script><!--Note: All init js like tiny slider, counter, countdown, maintenance, lightbox, gallery, swiper slider, aos animation etc.-->
        <script src="<%=request.getContextPath() %>/resources/landrick/js/app.js"></script><!--Note: All important javascript like page loader, menu, sticky menu, menu-toggler, one page menu etc. -->
    </body>
</html>
</html>
