						...
						<div class="row">
							<div class="col-lg-9 col-md-8">
								<div class="section-title">
									<h4 class="title mb-2">직업정보</h4>
									<p class="text-muted mb-0">직업 현장에서의 직무분석을 바탕으로 조사된 직업정보를 한국표준직업분류 기준과 한국표준산업분류 기준으로 확인할 수 있는 대한민국 직업사전입니다.</p>
								</div>
							</div>
							<!--end col-->
