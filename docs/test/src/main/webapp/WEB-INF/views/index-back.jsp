                            ...
                            <div class="col app-calendar-sidebar flex-grow-0 overflow-hidden d-flex flex-column" id="app-calendar-sidebar">
                                <div class="sidebar-wrapper">
                                    <div class="card-body d-flex justify-content-center">
                                        <button class="btn btn-primary btn-toggle-sidebar w-100" data-bs-toggle="modal" data-bs-target="#add-new-sidebar" onclick="insert()">
                    ...
                    <div class="modal modal-slide-in event-sidebar fade" id="add-new-sidebar">
                        <div class="modal-dialog sidebar-lg">
                            <div class="modal-content p-0">
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">버튼</button>
                                <div class="modal-header mb-1">
                                    <h5 class="modal-title">교육일정추가</h5>
                                </div>
...
<!--     <script src="/lms/resources/vuexy/app-assets/js/scripts/pages/app-calendar-events.js"></script> -->
