...
<div class="col-sm-12">
	...
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">
				<a href="#"><span class="badge rounded-pill badge-light-warning">Video</span></a>${subStdBoard.ssbName}</h4>
		</div>
		<div class="card-body">
			${subStdBoard.ssbContents} <br>
			<br>
			<c:forEach items="${subStdBoard.ssbAttachList }" var="ssbAttach">
				<div class="col-sm-12">
					<video width="100%;" height="100%;" controls
						src="<%=request.getContextPath() %>/student/manage/board/substdboard/stream?fileName=${ssbAttach.fileName}">
					</video>
				</div>
			</c:forEach>
		</div>
	...
	<div class="col-sm-12"  id="divMargin" style="text-align: right;">
...
<!-- 	<div class="card-body"> -->
<%-- 	    <h4 class="card-title"><a href="#"><span class="badge rounded-pill badge-light-warning">Video</span></a>${subStdBoard.ssbName}</h4> --%>
<!-- 	    <div class="d-flex"> -->
...
<%-- 	            <small class="text-muted"><fmt:formatDate value="${ssb.ssbDate }" pattern="yy-MM-dd" /></small> --%>
<!-- 	        </div> -->
<!-- 	    </div> -->
