			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-12 col-12">
							<div class="mb-1">
								<label class="form-label" for="counsRtTextOpen">피드백(공)</label>
<%-- 								<input id="counsRtTextOpen" class="form-control summernote" name="counsRtTextOpen" type="text" value="${counsRT.counsRtTextOpen }"><br> --%>
								<textarea class="form-control summernote" name="counsRtTextOpen" id="counsRtTextOpen" rows="20" placeholder="1000자 내외로 작성하세요." style="display: none;">${counsRT.counsRtTextOpen }</textarea>
							</div>
						</div>
						<div class="col-md-12 col-12">
							<div class="mb-1">
								<label class="form-label" for="counsRtTextHide">피드백(비)</label>
<%-- 								<input id="counsRtTextHide" class="form-control summernote" name="counsRtTextHide" type="text" value="${counsRT.counsRtTextHide }"><br> --%>
								<textarea class="form-control summernote" name="counsRtTextHide" id="counsRtTextHide" rows="20" placeholder="1000자 내외로 작성하세요." style="display: none;">${counsRT.counsRtTextHide }</textarea>
							</div>
						</div>
					</div>
				</div>
...
<input type="hidden" name="facId" value="${loginUser.usersId}">
			...
			<div class="col-12">
				...
				<c:if test="${not empty counsRT.counsRtTextHide }">
					<button type="button" class="btn btn-primary waves-effect waves-float waves-light" id="modifyBtn" onclick="modify_go();">완료</button>
				</c:if>
