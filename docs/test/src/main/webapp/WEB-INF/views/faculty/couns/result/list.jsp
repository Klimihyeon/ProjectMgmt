...
<body>
	...
	<h1>상담 내역</h1>
	<div class="card">
		<h3 class="card-header">상담 내역 목록</h3>
		<div
						...
						<tbody>
							<c:forEach var="couns" items="${counsList}"
								...
								<tr>
									...
									<td><button type="button" class="btn btn-primary" onclick="OpenWindow('detail.do?counsCode=${couns.counsCode}','입력창',850,840);">상세</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
