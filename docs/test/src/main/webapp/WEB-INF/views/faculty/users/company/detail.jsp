...
<body>
	<section class="bg-half-170 d-table w-100"></section>
		...
		<!-- 기업회원 정보 -->
	<div class="col-sm-12" id="divPadding">
	<div class="card" style="padding: 20px;">
		...
		<div class="col-md-12" style="text-align: right; padding-right: 20px; padding-top: 0px;">
			<button type="button" class="btn btn-primary waves-effect waves-float waves-light" id="cancelBtn" onclick="javascript:window.close();">수정</button>
