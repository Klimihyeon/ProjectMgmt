                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="page-next-level">
                            <h3 class="title mb-4">어떤 인재를 뽑을 계획이신가요?</h3>
                            ...
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        <li class="breadcrumb-item"><a href="#">JOBSTICK</a></li>
                                        <li class="breadcrumb-item"><a href="#">JOB-INFO</a></li>
...
<!--                         </div> -->
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" class="rounded shadow p-4" role="form" action="regist.do" method="post" name="registForm">
                                <input type="hidden" name="comId" value="${loginUser.usersId }">
                                <input type="hidden" name="comRegNo" value="${loginUser.comRegNo }">
                                    
                                    <div class="row">
                                    <div class="col-md-12">
                                    	<p style="color: #2F55D4; font-weight: bold;">
                                   		...
                                   		<br>                                   		
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <input name="hTitle" id="hTitle" type="text" class="form-control ps-5" value="">
                                                </div>
                                            </div> 
                                        </div> 
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                       <div class="mb-3">
                                           ...
                                           <input name="hWorktime" id="hWorktime" type="text" class="form-control ps-5" value="">
                                       	</div>
                                   	</div> 
                                   <br><br><br><br><br><br>
                                    	<p style="color: #2F55D4; font-weight: bold;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <input name="hHire" id="hHire" type="text" class="form-control ps-5" value="" onchange="hHireCheck();">
                                                </div>
                                            </div> 
                                        </div>    
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <input name="hQualification" id="hQualification"  type="text" class="form-control ps-5" >
                                                </div>
                                            </div> 
                                        </div>    
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <input name="hJobTask" id="hJobTask" type="text" class="form-control ps-5">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <input name="hPosition" id="hPosition" type="text" class="form-control ps-5">
                                                </div>
                                            </div> 
                                        </div> 
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <input name="hLocation" id="hLocation" type="text" class="form-control ps-5">
                                                </div>
                                            </div> 
                                        </div>     
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                	 <label class="form-label" for=hEdate> 
                                                    	<input name="hEdate" id="hEdate" type="date" class="form-control ps-5">
                                                    </label>
                                                </div>
                                            </div> 
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12" style="text-align: center;">
                                        	<button type="button" class="btn btn-primary" id="registBtn" onclick="regist_go();">공고등록</button>
                                        	<button type="button" class="btn btn-primary" id="registBtn">닫기</button>
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </form><!--end form-->
                            </div> 
